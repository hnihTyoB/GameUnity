...
4. Cấu hình trong Inspector:
   ...
   - **Spawn Check Radius**: Bán kính kiểm tra va chạm (VD: 1.0 hoặc 1.5)
     - ⚠️ **QUAN TRỌNG**: Shadow collider ~0.84 units, nên dùng 1.0-1.5 để tránh spawn sát tường
...
3. **Tăng `Spawn Check Radius` lên 1.0 hoặc 1.5** (shadow collider ~0.84 units)
4. Verify tường có Collider2D component
